...
setwd("C:/Users/Aarsh Batra/Desktop/tXnFlagger")


# Data------------------------------------------------------------------------

# Given the number of formats in which we receive data from the client
# should have one cleaning script for each format. As of now, I have
# only one script for the given Fretch Data.
